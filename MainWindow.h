...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// ColumnPassport
			// 
			this->ColumnPassport->Text = L"œ‡ÒÒÔÓÚ ÍÎËÂÌÚ‡";
			this->ColumnPassport->Width = 194;
			// 
			// ColumnBankName
			// 
			this->ColumnBankName->Text = L"Õ‡Á‚‡ÌËÂ ·‡ÌÍ‡";
			this->ColumnBankName->Width = 175;
			// 
			// ColumnInterestRate
			// 
			this->ColumnInterestRate->Text = L"œÓˆÂÌÚÌ‡ˇ ÒÚ‡‚Í‡";
			this->ColumnInterestRate->Width = 189;
			// 
			// ColumnMaturityTime
			// 
			this->ColumnMaturityTime->Text = L"—ÓÍ ÔÓ„‡¯ÂÌËˇ";
			...
			this->BankNameLabel->Text = L"Õ‡Á‚‡ÌËÂ ·‡ÌÍ‡";
			// 
			// BankFindline
			// 
			...
			this->BankNameFind->Text = L"œÓËÒÍ";
			...
			this->InterestRateLabel->Text = L"œÓˆÂÌÚÌ‡ˇ ÒÚ‡‚Í‡";
			// 
			// MaturityTimeLabel
			// 
			...
			this->InterestRateFind->Text = L"œÓËÒÍ";
			...
			this->TopToolMenu->Text = L"»ÌÒÚÛÏÂÌÚ˚";
			// 
			// ProgrammTools
			// 
			...
			this->DebugAVLBankName->Text = L"¿¬À-‰ÂÂ‚Ó (Õ‡Á‚‡ÌËÂ ·‡ÌÍ‡)";
			...
			this->DebugAVLInterestRate->Text = L"¿¬À-‰ÂÂ‚Ó (œÓˆÂÌÚÌ‡ˇ ÒÚ‡‚Í‡)";
